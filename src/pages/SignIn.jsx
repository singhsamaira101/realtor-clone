    ...
    <section>
        ...
        <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
            <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6">
                <img src="https://images.unsplash.com/flagged/photo-1564767609342-620cb19b2357" alt="keys"
                ...
                <form>
                    ...
                    text-sm sm:text-lg">
                        <p className="mb-6">Don't have an account?
                            ...
                            ease-in-out ml-4">Register</Link>
                        </p>
                        <p>
                            ...
                            hover:text-blue-800
                            transition duration-200
                            ease-in-out ml-4">Forgot Password?</Link>
                        </p>
                    </div>
